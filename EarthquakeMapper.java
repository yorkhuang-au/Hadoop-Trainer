...
<html lang="en" class="">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <title>hadoop-java-example/EarthquakeMapper.java at master · umermansoor/hadoop-java-example · GitHub</title>
...
<meta content="GitHub" property="og:site_name" /><meta content="object" property="og:type" /><meta content="https://avatars3.githubusercontent.com/u/862952?v=3&amp;s=400" property="og:image" /><meta content="umermansoor/hadoop-java-example" property="og:title" /><meta content="https://github.com/umermansoor/hadoop-java-example" property="og:url" /><meta content="hadoop-java-example - A very simple example of using Hadoop&#39;s MapReduce functionality in Java." property="og:description" />
    ...
    <meta content="collector.githubapp.com" name="octolytics-host" /><meta content="collector-cdn.github.com" name="octolytics-script-host" /><meta content="github" name="octolytics-app-id" /><meta content="CA044A5B:1D6D:43BDEE7:54BF15BA" name="octolytics-dimension-request_id" />
...
<meta content="DlsPZ/q88KLPbmvzQP3yrwHoecnCGbXncWF1u9DL5lRBZ9wcTSEADKIYW2CTR4GCQ28p+zPV/2lhfwE3UYpU3A==" name="csrf-token" />
  ...
  <div class="container clearfix">
    ...
    <div class="header-actions" role="navigation">
      ...
      <a class="button" href="/login?return_to=%2Fumermansoor%2Fhadoop-java-example%2Fblob%2Fmaster%2Fsrc%2Fmain%2Fjava%2Fcom%2Fumermansoor%2FEarthquakeMapper.java" data-ga-click="(Logged out) Header, clicked Sign in, text:sign-in">Sign in</a>
    </div>
...
<a href="/umermansoor/hadoop-java-example/blob/2f1b2a1f4d45e37fd28ad6faa701cf128c8f2e8b/src/main/java/com/umermansoor/EarthquakeMapper.java" class="hidden js-permalink-shortcut" data-hotkey="y">Permalink</a>

<!-- blob contrib key: blob_contributors:v21:8df68cc90c74116186e243a757a876dc -->
...
<div class="select-menu js-menu-container js-select-menu left">
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item ">
              ...
              <a href="/umermansoor/hadoop-java-example/blob/develop/src/main/java/com/umermansoor/EarthquakeMapper.java"
                 data-name="develop"
                 data-skip-pjax="true"
                 rel="nofollow"
            ...
            <div class="select-menu-item js-navigation-item selected">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/umermansoor/hadoop-java-example/blob/master/src/main/java/com/umermansoor/EarthquakeMapper.java"
                 data-name="master"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text css-truncate-target"
  ...
  <div class="commit file-history-tease">
    <div class="file-history-tease-header">
        <img alt="Umer Mansoor" class="avatar" data-user="862952" height="24" src="https://avatars2.githubusercontent.com/u/862952?v=3&amp;s=48" width="24" />
        <span class="author"><a href="/umermansoor" rel="author">umermansoor</a></span>
        <time datetime="2013-06-18T20:27:58Z" is="relative-time">Jun 18, 2013</time>
        <div class="commit-title">
            <a href="/umermansoor/hadoop-java-example/commit/45ba55775fa5c43a85528b79e302b721583652d8" class="message" data-pjax="true" title="made changes to the README to clarify Map-Reduce example only">made changes to the README to clarify Map-Reduce example only</a>
        </div>
    </div>
    ...
    <div id="blob_contributors_box" style="display:none">
      ...
      <ul class="facebox-user-list">
          <li class="facebox-user-list-item">
            <img alt="Umer Mansoor" data-user="862952" height="24" src="https://avatars2.githubusercontent.com/u/862952?v=3&amp;s=48" width="24" />
            <a href="/umermansoor">umermansoor</a>
          </li>
      </ul>
    </div>
  </div>
...
<div class="file-box">
    ...
    <div class="meta clearfix">
      ...
      <div class="actions">
        <div class="button-group">
          <a href="/umermansoor/hadoop-java-example/raw/master/src/main/java/com/umermansoor/EarthquakeMapper.java" class="minibutton " id="raw-url">Raw</a>
            <a href="/umermansoor/hadoop-java-example/blame/master/src/main/java/com/umermansoor/EarthquakeMapper.java" class="minibutton js-update-url-with-hash">Blame</a>
          <a href="/umermansoor/hadoop-java-example/commits/master/src/main/java/com/umermansoor/EarthquakeMapper.java" class="minibutton " rel="nofollow">History</a>
        </div><!-- /.button-group -->
  ...
  <div class="blob-wrapper data type-java">
      ...
      <tr>
        ...
        <td id="LC4" class="blob-code js-file-line"><span class="pl-k">import</span> <span class="pl-smi">org.apache.hadoop.io.LongWritable</span>;</td>
      </tr>
      <tr>
        <td id="L5" class="blob-num js-line-number" data-line-number="5"></td>
        <td id="LC5" class="blob-code js-file-line"><span class="pl-k">import</span> <span class="pl-smi">org.apache.hadoop.io.Text</span>;</td>
      </tr>
      <tr>
        <td id="L6" class="blob-num js-line-number" data-line-number="6"></td>
        <td id="LC6" class="blob-code js-file-line"><span class="pl-k">import</span> <span class="pl-smi">org.apache.hadoop.mapreduce.Mapper</span>;</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC8" class="blob-code js-file-line"><span class="pl-k">import</span> <span class="pl-smi">java.io.IOException</span>;</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC12" class="blob-code js-file-line"><span class="pl-c"> * This is the main Mapper class. </span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC14" class="blob-code js-file-line"><span class="pl-c"> * <span class="pl-k">@author</span> umermansoor</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC16" class="blob-code js-file-line"><span class="pl-s">public</span> <span class="pl-s">class</span> <span class="pl-en">EarthquakeMapper</span> <span class="pl-s">extends</span> </td>
      </tr>
      <tr>
        <td id="L17" class="blob-num js-line-number" data-line-number="17"></td>
        <td id="LC17" class="blob-code js-file-line">        <span class="pl-e">Mapper&lt;<span class="pl-stj">LongWritable</span>, <span class="pl-stj">Text</span>, <span class="pl-stj">Text</span>, <span class="pl-stj">DoubleWritable</span>&gt;</span> </td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC21" class="blob-code js-file-line"><span class="pl-c">     * The `Mapper` function. It receives a line of input from the file, </span></td>
      </tr>
      <tr>
        <td id="L22" class="blob-num js-line-number" data-line-number="22"></td>
        <td id="LC22" class="blob-code js-file-line"><span class="pl-c">     * extracts `region name` and `earthquake magnitude` from it, which becomes</span></td>
      </tr>
      <tr>
        <td id="L23" class="blob-num js-line-number" data-line-number="23"></td>
        <td id="LC23" class="blob-code js-file-line"><span class="pl-c">     * the output. The output key is `region name` and the output value is </span></td>
      </tr>
      <tr>
        <td id="L24" class="blob-num js-line-number" data-line-number="24"></td>
        <td id="LC24" class="blob-code js-file-line"><span class="pl-c">     * `magnitude`.</span></td>
      </tr>
      <tr>
        <td id="L25" class="blob-num js-line-number" data-line-number="25"></td>
        <td id="LC25" class="blob-code js-file-line"><span class="pl-c">     * <span class="pl-k">@param</span> key - Input key - The line offset in the file - ignored.</span></td>
      </tr>
      <tr>
        <td id="L26" class="blob-num js-line-number" data-line-number="26"></td>
        <td id="LC26" class="blob-code js-file-line"><span class="pl-c">     * <span class="pl-k">@param</span> value - Input Value - This is the line itself.</span></td>
      </tr>
      <tr>
        <td id="L27" class="blob-num js-line-number" data-line-number="27"></td>
        <td id="LC27" class="blob-code js-file-line"><span class="pl-c">     * <span class="pl-k">@param</span> context - Provides access to the OutputCollector and Reporter.</span></td>
      </tr>
      <tr>
        <td id="L28" class="blob-num js-line-number" data-line-number="28"></td>
        <td id="LC28" class="blob-code js-file-line"><span class="pl-c">     * <span class="pl-k">@throws</span> IOException</span></td>
      </tr>
      <tr>
        <td id="L29" class="blob-num js-line-number" data-line-number="29"></td>
        <td id="LC29" class="blob-code js-file-line"><span class="pl-c">     * <span class="pl-k">@throws</span> InterruptedException </span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC31" class="blob-code js-file-line">    <span class="pl-st">@Override</span></td>
      </tr>
      <tr>
        <td id="L32" class="blob-num js-line-number" data-line-number="32"></td>
        <td id="LC32" class="blob-code js-file-line">    <span class="pl-s">public</span> <span class="pl-st">void</span> <span class="pl-en">map</span>(<span class="pl-stj">LongWritable</span> <span class="pl-v">key</span>, <span class="pl-stj">Text</span> <span class="pl-v">value</span>, <span class="pl-stj">Context</span> <span class="pl-v">context</span>) <span class="pl-s">throws</span> </td>
      </tr>
      <tr>
        <td id="L33" class="blob-num js-line-number" data-line-number="33"></td>
        <td id="LC33" class="blob-code js-file-line">            <span class="pl-stj">IOException</span>, <span class="pl-stj">InterruptedException</span> {</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC35" class="blob-code js-file-line">        <span class="pl-st">String</span>[] line <span class="pl-k">=</span> value<span class="pl-k">.</span>toString()<span class="pl-k">.</span>split(<span class="pl-s1"><span class="pl-pds">&quot;</span>,<span class="pl-pds">&quot;</span></span>, <span class="pl-c1">12</span>);</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC37" class="blob-code js-file-line">        <span class="pl-c">// Ignore invalid lines</span></td>
      </tr>
      <tr>
        <td id="L38" class="blob-num js-line-number" data-line-number="38"></td>
        <td id="LC38" class="blob-code js-file-line">        <span class="pl-k">if</span> (line<span class="pl-k">.</span>length <span class="pl-k">!=</span> <span class="pl-c1">12</span>) {</td>
      </tr>
      <tr>
        <td id="L39" class="blob-num js-line-number" data-line-number="39"></td>
        <td id="LC39" class="blob-code js-file-line">            <span class="pl-stj">System</span><span class="pl-k">.</span>out<span class="pl-k">.</span>println(<span class="pl-s1"><span class="pl-pds">&quot;</span>- <span class="pl-pds">&quot;</span></span> <span class="pl-k">+</span> line<span class="pl-k">.</span>length);</td>
      </tr>
      <tr>
        <td id="L40" class="blob-num js-line-number" data-line-number="40"></td>
        <td id="LC40" class="blob-code js-file-line">            <span class="pl-k">return</span>;</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC43" class="blob-code js-file-line">        <span class="pl-c">// The output `key` is the name of the region</span></td>
      </tr>
      <tr>
        <td id="L44" class="blob-num js-line-number" data-line-number="44"></td>
        <td id="LC44" class="blob-code js-file-line">        <span class="pl-stj">String</span> outputKey <span class="pl-k">=</span> line[<span class="pl-c1">11</span>];</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC46" class="blob-code js-file-line">        <span class="pl-c">// The output `value` is the magnitude of the earthquake</span></td>
      </tr>
      <tr>
        <td id="L47" class="blob-num js-line-number" data-line-number="47"></td>
        <td id="LC47" class="blob-code js-file-line">        <span class="pl-st">double</span> outputValue <span class="pl-k">=</span> <span class="pl-stj">Double</span><span class="pl-k">.</span>parseDouble(line[<span class="pl-c1">8</span>]);</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC49" class="blob-code js-file-line">        <span class="pl-c">// Record the output in the Context object</span></td>
      </tr>
      <tr>
        <td id="L50" class="blob-num js-line-number" data-line-number="50"></td>
        <td id="LC50" class="blob-code js-file-line">        context<span class="pl-k">.</span>write(<span class="pl-k">new</span> <span class="pl-stj">Text</span>(outputKey), <span class="pl-k">new</span> <span class="pl-stj">DoubleWritable</span>(outputValue));</td>
      </tr>
      <tr>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer" role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2015 <span title="0.03556s from github-fe128-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
